...
public class ServerPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Server";
	...
	private ServerPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ServerPersistentManager();
		}
